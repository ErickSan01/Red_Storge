...
namespace Scripts{
    ...
    public class Secuencia{
        ...
        /// <summary>
        /// Método que devuelve la siguiente clave en la secuencia 2 para el módulo especificado.
        /// </summary>
        /// <param name="clave">Clave actual en la secuencia.</param>
        /// <param name="modulo">Número del módulo.</param>
        /// <returns>La siguiente clave en la secuencia 2.</returns>
        /// <remarks>
        /// Este método contiene la secuencia 2, la cual se usa cuando un pergamino de puente es contestado erróneamente.
        /// También se usa cuando se contesta el laberinto o la recuperación.
        /// </remarks>
